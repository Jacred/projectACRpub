...
FishGroup20: ; Prologue Pondwater
FishGroup20_Old:
	db 179, MAGIKARP,   10
	db 217, MAGIKARP,   10
	db $ff, POLIWAG,    10
...
FishGroup21: ; Prologue Lakewater
FishGroup21_Old:
	db 179, MAGIKARP, 10
	db 217, MAGIKARP, 10
	db $ff, GOLDEEN,  10
...
FishGroup22: ; Prologue Poolwater
FishGroup22_Old:
	db 179, MAGIKARP, 10
	db 217, MAGIKARP, 10
	db $ff, KRABBY,   10
...
; 42
	...
	db AZUMARILL,  30 ; day
; 43
	db POLIWHIRL,  50 ; nite
	db AZUMARILL,  50 ; day
; 44
	db POLIWRATH,  55 ; nite
	db SEAKING,    50 ; nite
; 45
	db AZUMARILL,  50 ; nite
	db POLITOED,   55 ; day
; 46
	db SEAKING,    50 ; nite
	db POLIWRATH,  55 ; day
